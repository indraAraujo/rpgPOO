...
public class SetUp extends JFrame implements ActionListener{
    ...
    public void actionPerformed (ActionEvent event){
        ...
        if(clicked==ataqueS_b){
            ...
            nivel.getVilao().levarDano(nivel.getProtagonista().ataquesimples(dano));
            vidaVilao.setText(String.valueOf(nivel.getVilao().getVida()));
            nivel.getProtagonista().levarDano(nivel.getVilao().getAtaque());
            vidaProtago.setText(String.valueOf(nivel.getProtagonista().getVida()));
        }
